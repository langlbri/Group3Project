 ...
 * @author group 3
 *
 * this class is to define a Shoe object. The shoe holds 6 decks of cards The
 * dealer interacts with the Shoe to deal cards The shoe has logic for when to
 * reset, it does not use all of the cards
 */
public class Shoe {
