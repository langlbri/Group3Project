 ...
 * @author group 3
 *
 * this is the BlackjackGame class that extends game. It is used to initialize
 * players and scores, and handle game logic. It delegates dealer and player
 * logic accordingly. It instantiates a Shoe, Dealer, BlackjackPlayer
 */
...
public class BlackjackGame extends Game {
    ...
    private void startRound(Scanner scanner) {
        ...
        if (player.getHand().isBlackjack()) {
            //TODO make the output nicer, I added a lot of stars to make it obvious while testing 500 rounds
