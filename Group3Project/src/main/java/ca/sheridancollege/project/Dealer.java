...
public class Dealer extends BlackjackPlayer {
    ...
    /**
     * Deals initial cards in the following order: 1. Card to player 2. Card to
     * dealer (face up) 3. Card to player 4. Card to dealer (hidden)
     */
    ...
    /**
     * Dealer's turn: first reveal the hidden card, then hit until total is at
     * least 17. This logic is now moved into the dealer's play() method.
     */
    @Override
    public void play() {
        revealHiddenCard();
